...
- Configuracion regional por pais, zona horaria, moneda y organizacion.
- IOC Center con CRUD, busqueda, filtros y export CSV/JSON.
- VirusTotal integrado con API key protegida, cache local y vista interna.
- Assets ampliados con criticidad, pais, estado, tecnologia y detalle.
