...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "es": {
        ...
        "threat_intelligence_center": "Centro TI",
        "audit_logs": "Registro de auditoria",
        "threat_map": "Mapa de amenazas",
        "api_token": "Token de API",
        "generate_new_token": "Generar nuevo token",
        "api_token_description": "Utilice este token para llamadas REST autenticadas.",
    ...
    "en": {
        ...
        "threat_intelligence_center": "Threat Intel Center",
        "audit_logs": "Audit Logs",
        "threat_map": "Threat Map",
        "api_token": "API Token",
        "generate_new_token": "Generate new token",
        "api_token_description": "Use this token for authenticated REST calls.",
